...
#define CHIP8_WINDOW_MULTIPLIER 10 //Multiplies the window size by this factor, so 640x320 instead of 64x32, for every pixel drawn, 10 pixels will be drawn to the display
